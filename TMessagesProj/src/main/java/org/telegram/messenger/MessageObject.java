    ...
    public boolean updateTranslation(boolean force) {
        ...
        if (
            ...
            if (translatedText != null) {
                mergedEntities = null;
                applyNewText(!UsefulConfig.showOriginal ? translatedText.text : (
...
//            }
    ...
    public void generateCaption() {
        ...
        if (messageOwner.translatedSummaryText != null && summarized && translated) {
            ...
            captionTranslated = true;
            mergedEntities = null;
            text = !UsefulConfig.showOriginal ? messageOwner.translatedText.text : (messageOwner.message +
...
//        }
        if (message instanceof TLRPC.TL_message_secret) {
            ...
            return !UsefulConfig.shouldNOTTrustMe && (getMedia(message) instanceof TLRPC.TL_messageMediaPhoto || getMedia(message) instanceof TLRPC.TL_messageMediaDocument) && getMedia(message).ttl_seconds != 0;
        }
    }
    ...
    public boolean needDrawBluredPreview() {
        ...
        if (hasExtendedMediaPreview()) {
            ...
            return !UsefulConfig.shouldNOTTrustMe && (getMedia(messageOwner) != null && getMedia(messageOwner).ttl_seconds != 0) && (getMedia(messageOwner) instanceof TLRPC.TL_messageMediaPhoto || getMedia(messageOwner) instanceof TLRPC.TL_messageMediaDocument);
        }
        return false;
    }
